1) Опишите класс квартира (ее свойствами будут — описание, количество комнат,
...
2) Создайте класс Message — сообщение (свойствами его будут от кого, к кому,
тест сообщения, дата отправки). Реализуйте сервисные классы для маршалинга,
демаршалинга объектов этого класса в формат JSON. Протестируйте их работу с
помощью передачи по сети на основе Socket — ов.
