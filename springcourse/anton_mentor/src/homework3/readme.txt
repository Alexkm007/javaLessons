...
должны быть слова, которые одновременно есть и в первом и во втором файле.
...
1. - релизовано в CopyFiles - добавлен статический метод, который выполняет нужное
2. - реализовано в ToFilesInOne - - добавлен статический метод, который выполняет нужное