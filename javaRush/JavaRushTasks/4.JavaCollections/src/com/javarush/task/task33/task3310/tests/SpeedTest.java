...
public class SpeedTest {
    ...
    public void testHashMapStorage(){
        ...
        Long timeForHashMapStorageStrategy = getTimeToGetIds(shortener1, origStrings, idsHashMapStorageStrategy);
        Long timeForHHashBiMapStorageStrategy = getTimeToGetIds(shortener2, origStrings, idsHashBiMapStorageStrategy);
        ...
        Long timeForStringsForHashMapStorageStrategy = getTimeToGetStrings(shortener1, idsHashMapStorageStrategy, stringsHashMapStorageStrategy);
        Long timeForStringsForHHashBiMapStorageStrategy = getTimeToGetStrings(shortener2, idsHashBiMapStorageStrategy, stringsHashBiMapStorageStrategy);
